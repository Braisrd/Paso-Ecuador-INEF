...
const Home = () => {
    ...
    return (
        <div className="min-h-screen bg-[#0a0a0f] text-white selection:bg-sky-400 selection:text-black">
            {/* Header / Top Actions */}
            ...
            <section className="min-h-[90vh] flex flex-col items-center justify-center p-6 relative overflow-hidden">
                ...
                <div className="relative w-64 h-64 md:w-80 md:h-80 mb-8 animate-float">
                    <img src="/logo.png" className="w-full h-full object-contain drop-shadow-[0_0_40px_rgba(99,102,240,0.4)]" alt="Logo" />
                </div>
            ...
            <section id="events" className="py-24 px-4 md:px-8 max-w-7xl mx-auto w-full">
                        ...
                        <div className="glass-panel p-8 rounded-[3rem] border border-white/10 transform rotate-[-3deg] group-hover:rotate-1 transition-all duration-700 shadow-2xl bg-black/40 backdrop-blur-xl">
                            <div className="flex items-center gap-6 mb-8 border-b border-white/10 pb-6">
                                ...
                                <div>
                                    ...
                                    <div className="font-black text-2xl text-white">Próximamente...</div>
                                </div>
                            </div>
            ...
            {/* Footer */}
            <footer className="py-20 border-t border-white/5 bg-[#050507]">
